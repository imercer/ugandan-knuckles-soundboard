...
/* Advertising Code */
    ...
    if( /(android)/i.test(navigator.userAgent) ) { // for android & amazon-fireos
      ...
      admobid = {
        banner: 'ca-app-pub-5354491797983322/6448521769', //TODO: CHANGE THIS TO THE NEW APP's BANNER ID - iOS
        interstitial: 'ca-app-pub-5354491797983322/5932859902' //TODO: CHANGE THIS TO THE NEW APP's INTERSTERTIAL ID -iOS
      };
...
function ringtoneSet(sound,setting) {
    ...
    if(displayAds == "no") {
        ...
        AdMob.prepareInterstitial({
                adId: 'ca-app-pub-5354491797983322/5932859902', //TODO: SET THIS TO INTERSTERTIAL AD ID
                autoShow: false
            });
    };
